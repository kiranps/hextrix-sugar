...
function update_index_html_with_iframe()
{
	...
	updated_body_content=body_before_canvas[0].concat("\n  <iframe  src=\"users_index_page.html\" style=\"width:100%;height:100%\" scrolling=\"yes\"></iframe>\n</div>\n</body>");
...
module.exports.help = function() {
    ...
    console.log('give no option to include your webpage as iframe inside the sugar web template\'s page\n  IF you know about sugar web and wissh to alter and write your own toolbutton and using the sugar web api then issue the option --iframe along with the cordova build sugar command');
    process.exit(0);
}
